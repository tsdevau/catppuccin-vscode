import type { AccentName, Colors, AnsiColors, FlavorName } from "@catppuccin/palette"
...
export type CatppuccinBracketMode = "rainbow" | "dimmed" | "monochromatic" | "neovim"
...
export type ColorOverrides = Partial<FlavorsPlusAll<Partial<CatppuccinPalette>>>
