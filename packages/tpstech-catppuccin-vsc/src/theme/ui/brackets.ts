...
type BracketHLs = keyof PickStartsWith<WorkbenchColors, "editorBracketHighlight">
...
const brackets = (context: ThemeContext): Record<BracketHLs, string> => {
  ...
  const styles = {
    ...
    dimmed: {
      ...
      "editorBracketHighlight.unexpectedBracket.foreground": shade(palette.red, dimAmount),
    },
    monochromatic: {
